...
document.getElementById('bag').addEventListener('click', function(){
    ...
    let band_size = document.getElementsByClassName('band_size')[0].innerText.toLowerCase();
    
    let url = `http://localhost:4000/data/watch?name=${name}&type=${type}&case_size=${sizeCheck}&connect=${connect}&band_size=${band_size}`; 
