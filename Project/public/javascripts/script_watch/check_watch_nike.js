...
document.getElementById('bag').addEventListener('click', function(){
    ...
    let name = document.getElementsByClassName('name_cart')[0].innerText.toLowerCase();
    let type = document.getElementsByClassName('watch-title')[0].innerText.toLowerCase();

    // console.log(name);
    // console.log(type);

    let url = `http://localhost:4000/data/watch?name=${name}&type=${type}&case_size=${size}&connect=${connect}`;
